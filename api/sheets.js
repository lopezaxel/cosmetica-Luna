...
module.exports = async (req, res) => {
  ...
  const { nombre, celular, fecha_hora, servicio } = req.body || {};

  if (!nombre || !celular || !fecha_hora || !servicio) {
    return res.status(400).json({ error: 'Faltan datos: nombre, celular, fecha_hora, servicio' });
  }
